...
<ArticleSvg src="island-skies-astro/articles/emissionnebulaemitlight/emission_nebula_process" alt="Diagram showing how hot stars energize nebula gas to emit light" caption="How emission nebulae shine. UV radiation from hot stars ionizes the gas, and electrons recombining at different energy levels produce the characteristic colors." />

## Explore: IC 1318 and the Crescent Nebula

The image below shows IC 1318, a large emission nebula surrounding the star Sadr (γ Cygni) in the constellation Cygnus. Click the annotated object to navigate to a closer view of NGC 6888, the Crescent Nebula — a smaller emission nebula formed by stellar winds from a Wolf-Rayet star.
